...
public class NotasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed_primeiraNota = findViewById(R.id.tela2_edtxt_nota1);
        ed_segundaNota = findViewById(R.id.tela2_edtxt_nota2s);
        alunoSituacao = findViewById(R.id.tela2_txt_status);
    }
